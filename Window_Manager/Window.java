...
public class Window {
    ...
    /**
     * A boolean to keep track of whether or not th window is selected.
     */
    ...
    /**
     * Sets the pick variable for the Window to be either selected or not selected.
     * @param selected The selected state of the Window
     */
    ...
    /**
     * Gets whether or not the Window is selected.
     * @return whether or not the Window is selected
     */
    ...
    /**
     * Method to see if a point is contained in a window.
     * @param x x-coordinate
     * @param y y-coordinate
     * @return Whether or not the point is in the window
     */
